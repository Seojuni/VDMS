            ...
            if page_req.ok:
                ...
                for i in range(0,11):
                    ...
                    if detail_req.ok:
                        ...
                        last_mod_date = detail_soup.find('span', attrs={'data-testid': 'vuln-last-modified-on'}).get_text()
                        ...
                        cwe_id = detail_soup.find('td', attrs={'data-testid': 'vuln-CWEs-link-0'}).get_text()

                        cwe_name = detail_soup.select('div#vulnTechnicalDetailsDiv > table > tbody > tr > td')[1].get_text()
